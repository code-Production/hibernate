...
import com.geekbrains.hibernate.model.ProductDao;
...
public class ProductDaoImpl implements ProductDao {
    ...
    @Override
    public List<Customer> getCustomerHistory(Long id) {
        try(Session session = sessionFactory.getCurrentSession()) {
            session.beginTransaction();
            List<Customer> history = session.get(Product.class, id).getOrders().stream()
